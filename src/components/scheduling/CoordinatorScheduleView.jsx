// src/components/scheduling/CoordinatorScheduleView.jsx
...
const CoordinatorScheduleView = ({ 
  coordinatorType, // 'makerspace', 'vocational', 'admin'
  makerspaceSchedule = [], // All coordinator appointments (filtered by type)
  makerspaceActions,
  userProfile 
}) => {
  ...
  // Filter appointments for this coordinator type
  ...
  const getCoordinatorIcon = () => {
    switch (coordinatorType) {
      case 'makerspace': return <Wrench size={14} />;
  ...
  const getEntryColor = () => {
    switch (coordinatorType) {
      case 'makerspace': return 'bg-blue-100 border-blue-300 text-blue-800';
          ...
          <div className="bg-white rounded-lg shadow-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6 border-b border-gray-200">
              <h3 className="text-lg font-semibold text-[#292929]">
                {editingEntry ? 'Edit Appointment' : 'Add New Appointment'}
              </h3>
            </div>
            ...
            <form onSubmit={handleAddEntry} className="p-6 space-y-4">
              ...
              <div>
                <label className="block text-sm font-medium text-[#292929] mb-1">Client Name</label>
                <input
                  type="text"
              ...
              <div className="flex justify-end space-x-3 pt-4">
                ...
                >
                  {editingEntry ? 'Update' : 'Add'} Appointment
                </button>
              </div>
            </form>
          </div>
...
export default CoordinatorScheduleView;